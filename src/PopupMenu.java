...
public class PopupMenu extends java.awt.PopupMenu implements ActionListener, ItemListener
{
	...
	private static final String APPLICATION_VERSION_NUMBER = "1.0 (2007-07-24)";

	private static final String CREDIT_CHRONOLOGY = Messages.getString( "PopupMenu.3" );
	...
	private static final String POPUP_SHOW_DIFFERENT_DAY_INDICATOR = Messages.getString( "PopupMenu.13" );
    ...
    public PopupMenu()
	{
	    ...
	    checkboxMenuItem =
	    	new CheckboxMenuItem
	    	(
	    		POPUP_SHOW_DIFFERENT_DAY_INDICATOR,
	    		Properties.getInstance().getPropertyBoolean( Properties.PROPERTY_SHOW_DIFFERENT_DAY_INDICATOR, true )
	    	);
    ...
    public void actionPerformed( ActionEvent actionEvent )
	{
    	...
    	{
    		m_popupDisabled = true;
    		AddRemoveTimeZones.create().setVisible( true );
    		m_popupDisabled = false;
    		return;
    	}
    	...
    	if( source instanceof MenuItem && POPUP_RENAME_TIME_ZONES.equals( ( (MenuItem)source ).getLabel() ) )
    	{
        	...
        	m_popupDisabled = true;
    		RenameTimeZones.create().setVisible( true );
    		m_popupDisabled = false;
    		return;
    	}
    	...
    	if( source instanceof MenuItem && POPUP_TIME_TRAVEL.equals( ( (MenuItem)source ).getLabel() ) )
    	{
    		...
    		m_popupDisabled = true;
    		TimeTravel.create().setVisible( true );
    		m_popupDisabled = false;
    		return;
    	}
	...
	public void itemStateChanged( ItemEvent itemEvent )
    {
    	...
    	// Handle the previous day indicator option.
    	else if( POPUP_SHOW_DIFFERENT_DAY_INDICATOR.equals( label ) )
    	{
    		Properties.getInstance().setProperty( Properties.PROPERTY_SHOW_DIFFERENT_DAY_INDICATOR, Boolean.toString( checkboxMenuItem.getState() ) );
    	}
